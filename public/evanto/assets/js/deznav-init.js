...
(function($) {
	...
	if(direction == 'rtl' || body.attr('direction') == 'rtl'){
		jQuery('.main-switcher').attr('href','/evanto/assets/css/switcher-rtl.css');
		jQuery('.main-plugins').attr('href','/evanto/assets/css/plugins-rtl.css');
		jQuery('.main-css').attr('href','/evanto/assets/css/style-rtl.css');
    }else{
		jQuery('.main-switcher').attr('href','/evanto/assets/css/switcher.css');
		jQuery('.main-plugins').attr('href','/evanto/assets/css/plugins.css');
		jQuery('.main-css').attr('href','/evanto/assets/css/style.css');
	}
